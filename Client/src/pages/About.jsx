...
const About = () => {
  ...
  return (
    <motion.section className="about-section container">
      {/* Welcome Section - Animate when 20% visible */}
      <StaggeredContainer className="main-section" threshold={0.2}>
        {user ? (
      ...
      {/* About Content - Animate when 30% visible */}
      <StaggeredContainer className="about-content" threshold={0.3}>
        <motion.div className="about-text" variants={ITEM_VARIANTS}>
          <motion.p variants={ITEM_VARIANTS}>
            We provide the best user experience with cutting-edge technology and
            personalized services, focusing on security, performance, and
            satisfaction.
          </motion.p>
          <motion.p variants={ITEM_VARIANTS}>
      ...
      {/* Features - Animate when 40% visible */}
